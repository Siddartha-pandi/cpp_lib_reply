#############################################################################
# Makefile for building: FiringAnalysis
# Generated by qmake (3.1) (Qt 5.15.13)
# Project:  FiringAnalysis.pro
# Template: app
# Command: /usr/lib/qt5/bin/qmake -o Makefile FiringAnalysis.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = FiringAnalysis1.0.0
DISTDIR = /home/siddartha/FiringAnalysis/build/obj/FiringAnalysis1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1
...
SOURCES       = main.cpp \
		...
		replyscreen.cpp build/moc/moc_home.cpp \
...
FiringAnalysis:  $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: FiringAnalysis.pro /usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++/qmake.conf /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/unix.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/linux.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/sanitize.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/gcc-base.conf \
		...
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/lex.prf \
		FiringAnalysis.pro
	$(QMAKE) -o Makefile FiringAnalysis.pro
/usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf:
/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/unix.conf:
/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/linux.conf:
/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/sanitize.conf:
...
distdir: FORCE
	...
	$(COPY_FILE) --parents parser.h parser_format_config.h parserdialog.h home.h eventview.h parametrview.h trajectoryview.h geographicalinfo.h acousticpanorama.h demongraph.h parameterinfotree.h trajectorytable.h replyscreen.h $(DISTDIR)/
	$(COPY_FILE) --parents main.cpp home.cpp parser.cpp parserdialog.cpp eventview.cpp parametrview.cpp trajectoryview.cpp geographicalinfo.cpp acousticpanorama.cpp demongraph.cpp trajectorytable.cpp parameterinfotree.cpp replyscreen.cpp $(DISTDIR)/
...
install_target: first FORCE
	@test -d $(INSTALL_ROOT)/opt/FiringAnalysis/bin || mkdir -p $(INSTALL_ROOT)/opt/FiringAnalysis/bin
	$(QINSTALL_PROGRAM) $(QMAKE_TARGET) $(INSTALL_ROOT)/opt/FiringAnalysis/bin/$(QMAKE_TARGET)
	-$(STRIP) $(INSTALL_ROOT)/opt/FiringAnalysis/bin/$(QMAKE_TARGET)

uninstall_target: FORCE
	-$(DEL_FILE) $(INSTALL_ROOT)/opt/FiringAnalysis/bin/$(QMAKE_TARGET)
	-$(DEL_DIR) $(INSTALL_ROOT)/opt/FiringAnalysis/bin/ 
