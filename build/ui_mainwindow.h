...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        actionViewParameter->setObjectName(QString::fromUtf8("actionViewParameter"));
        ...
        actionViewTrajectory->setObjectName(QString::fromUtf8("actionViewTrajectory"));
        actionPrintParameterView = new QAction(MainWindow);
        actionPrintParameterView->setObjectName(QString::fromUtf8("actionPrintParameterView"));
        actionPrintEventView = new QAction(MainWindow);
        actionPrintEventView->setObjectName(QString::fromUtf8("actionPrintEventView"));
        actionPrintTrajectoryView = new QAction(MainWindow);
        actionPrintTrajectoryView->setObjectName(QString::fromUtf8("actionPrintTrajectoryView"));
        ...
        leftTableLayout->setObjectName(QString::fromUtf8("leftTableLayout"));
        label_left_header = new QLabel(centralwidget);
        label_left_header->setObjectName(QString::fromUtf8("label_left_header"));
...
"}"));
        ...
        rightTopLayout->setObjectName(QString::fromUtf8("rightTopLayout"));
